...
При создании базы данных предусмотреть:
    ...
    При помощи триггеров установить связь между полем «Общее количество поставленного материала» и таблицей «Учет поставок материалов и покупных деталей»

Список запросов:
01) Найти и вывести сведения о цехах, ответственных за производственную программу предприятия (за план выпуска после заданной даты):
•	код готовой детали
•	план выпуска на год
•	Номер цеха, выпускающего это изделие.
•	Номер участка, выпускающего это изделие

02) Вывести наименования всех цехов:
    в сборке каждой готовой детали, поставка которой запланирована на заданный месяц, хотя бы одна операция выполняется  в этом цехе

03) Найти и вывести для каждого готовой детали:
•	код детали
•	сколько разных цехов участвуют (непосредственно) в его сборке
*/
